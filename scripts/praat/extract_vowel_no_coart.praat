...
outFile$ = "formants_nocoart.csv"

# Where are the .wav and textgrid files located?
filePath$ = "../../sound_files/noCoartcomp/"
...
for file to numberOfFiles
	...
	labels = Count labels: 1, "exclude"
	labID$ = Get label of interval: 1, 1

	if labels = 0

		# Calculate mid-point of vowel 
		vowelStart = Get start point: 1, 2
		vowelEnd  = Get end point: 1, 2
	...
	fileappend 'outputDir$'/formants_nocoart.csv 'prefix$','f1:2','f2:2','f3:2', 'f1on:2','f2on:2','f3on:2', 'f1off:2','f2off:2','f3off:2' 'newline$'
